...
def recommend (user, clusters, fn, k):
    print("############ RECOMMENDATION FOR USER NO. %d ############" %(user))
...
# sample entries 
print("\n\n____________________Welcome to the Movie Recommender____________________\n")
...
if(answer == "Y" or answer == "y" or answer == "yes"):
    ...
    user = int(input("\nPlease enter the ID of the existing user you'd like to recommend to [Note: Max is 943](Y/N): "))

print("\nPlease enter the number of clusters you'd like to test with: (a good one to try is 10)")
bound = int(input("[Please note that the Max is 943]"))

k = 5

print("\nRecommendations with Euclidean Distance")
...
print("\n\n____________________END OF RECOMMENDATION____________________")